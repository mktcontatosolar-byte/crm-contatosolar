  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background p-4">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-[12%] right-[8%] h-80 w-80 rounded-full bg-[color:color-mix(in_oklab,var(--chart-2)_18%,transparent)] blur-3xl" />
        <div className="absolute inset-x-0 top-0 h-48 bg-[linear-gradient(180deg,color-mix(in_oklab,var(--chart-1)_14%,transparent),transparent)]" />
      </div>

      <Card className="relative w-full max-w-md rounded-3xl border border-border/60 bg-card/94 shadow-xl backdrop-blur">
        <CardHeader className="space-y-4 text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-border/60 bg-[linear-gradient(135deg,color-mix(in_oklab,var(--primary)_22%,transparent),color-mix(in_oklab,var(--chart-2)_18%,transparent))] text-foreground">
