...
export default function StatCard({
  ...
  return (
    <Card className="crm-surface-panel rounded-3xl">
      ...
      <div className="mx-6 mt-auto h-1 rounded-full bg-[linear-gradient(90deg,var(--color-chart-3),var(--color-chart-1),transparent)]" />
    </Card>
  )
}
