...
export default function ManualLeadDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent showCloseButton className="max-h-[88vh] max-w-5xl overflow-hidden rounded-[2rem] p-0">
        <DialogHeader>
          <div className="space-y-2 border-b border-border/60 px-6 pt-6 pb-5">
        ...
        <form className="flex max-h-[calc(88vh-88px)] flex-col" onSubmit={handleSubmit}>
