        ...
        <CardHeader className="border-b border-border/60 bg-card/80">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-3">
              <span className="inline-flex w-fit rounded-full border border-sky-500/20 bg-sky-500/10 px-3 py-1 text-xs font-medium text-sky-700 dark:text-sky-300">
                Atendimento
              </span>
                ...
                <div className="grid gap-3 lg:grid-cols-3">
                  ...
                  <div className="rounded-[1.5rem] border border-amber-500/20 bg-amber-500/10 p-4">
                    ...
                    <Button
                      type="button"
                      variant="outline"
                      className="mt-4 w-full rounded-3xl border-amber-500/30 bg-background/80"
                      disabled={updating}
